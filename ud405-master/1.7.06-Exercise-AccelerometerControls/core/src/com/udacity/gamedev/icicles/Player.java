...
public class Player {
    ...
    public void update(float delta) {
        ...
        float inputX = -Gdx.input.getAccelerometerY() / (Constants.ACCELERATION_GRAVITY * Constants.ACCELEROMETER_SENSITIVITY);

        // TODO: Use the accelerometer input to move the player
        position.x += -delta * inputX * Constants.PLAYER_MOVEMENT_SPEED;
