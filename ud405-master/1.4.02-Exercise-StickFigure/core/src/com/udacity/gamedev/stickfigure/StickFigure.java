...
public class StickFigure extends ApplicationAdapter {
    ...
    public void render() {
        ...
        shapeRenderer.line(100, 0,150, 25);
        shapeRenderer.line(200,0,150,25);
        shapeRenderer.line(100,125,150,150);
        shapeRenderer.line(200,125,150,150);
        shapeRenderer.line(150,25,150,175);
        shapeRenderer.end();
        shapeRenderer.begin(ShapeRenderer.ShapeType.Filled);
        shapeRenderer.circle(150,200,25);
        shapeRenderer.end();
